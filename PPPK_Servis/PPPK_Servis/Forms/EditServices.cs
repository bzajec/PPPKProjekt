...
namespace PPPK_Servis.Forms
{
    public partial class EditServices : Form
    {
        ...
        {
            Servi servis = new Servi();
            servis.Vozilo = lbVehicles.SelectedItem as Vozilo;
            servis.Item = lbItems.SelectedItem as Item;
            servis.VoziloID = (lbVehicles.SelectedItem as Vozilo).IDVozilo;
            servis.ItemID = (lbItems.SelectedItem as Item).IDItem;
            pPPK_ProjektEntities.Servis.Add(servis);
